...
* **Frontend**: HTML5, CSS3 (Premium Glassmorphism Design), Vanilla JavaScript
* **Backend & Database**: Firebase (Hosting, Firestore Database, Authentication)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Anik-da/SmartVote-India.git
   ```
2. Navigate into the directory:
   ```bash
   cd SmartVote-India
   ```
3. Run a local development server using `npx`:
   ```bash
   npx serve .
   ```
